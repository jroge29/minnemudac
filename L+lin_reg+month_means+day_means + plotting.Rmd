...
dat = data.frame(month = factor(months, levels = c('march', 'april', 'may', 'june', 'july', 'august', 'september', 'october')), attendance = value)
ggplot(dat, aes(x = month, y = attendance)) +
  geom_bar(color = "red", stat = "identity", position = "dodge") + ggtitle("Average attendance by Month, MLB")
```
...
dat = data.frame(month = factor(months, levels = c('march', 'april', 'may', 'june', 'july', 'august', 'september')), attendance = value)
dat
ggplot(dat, aes(x = month, y = attendance)) +
  geom_bar(color = "blue", stat = "identity", position = "dodge") + ggtitle("Average attendance by Month, Twins only")
```
