...
avg_temp_by_month = c(mean(mar$murica_temp),mean(apr$murica_temp),mean(may1$murica_temp),mean(jun$murica_temp),mean(jul$murica_temp),mean(aug$murica_temp),mean(sep$murica_temp),mean(oct$murica_temp))

avg_temp_by_month.t = c(mean(mar$murica_temp),mean(apr$murica_temp),mean(may1$murica_temp),mean(jun$murica_temp),mean(jul$murica_temp),mean(aug$murica_temp),mean(sep$murica_temp))
...
ggplot(dat, aes(x = month, y = attendance, group = 1)) + ylim(0, 50000) +
  ...
  ggtitle("Average attendance by Month, MLB (Temperature in red)")
```
